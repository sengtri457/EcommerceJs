const dataSmall = [
  ...
  //   ac
  {
    ...
    usPriceoff: "$74.99",
    Priceoff: "-40%",
    typeOfShirt: "Acessory Backpacks",
    MaxQuantity: 50,
    similar: "top",
  },
  {
...
const displayItems = (items) => {
  const showing = items
    .map((a) => {
      return `
 <div class="col-lg-3 mb-4 col-6 " data-aos="zoom-in-up">
